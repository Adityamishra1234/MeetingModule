      ...
      child: Scaffold(
        ...
        body: controller.obx(
            ...
            children: [
              ...
              // Center(
              //   child: Text("${meetingData.nameOfTheMeeting}",
              //     maxLines: 1,
                ...
                child: Padding(
                  ...
                  child: ListView(children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text("Meeting Details", style: GoogleFonts.aBeeZee(
                            textStyle: TextStyle(
                              fontSize: 15,
                              color: ThemeConstants.paleYellow,
                              fontWeight: FontWeight.w500
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CustomAutoSizeTextMontserrat(
                                  text: "Registration Link:",    //backend se hi space aara h isme...this should not be happening.
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14,
                                  textColor: ThemeConstants.whitecolor,
                                ),
                                ...
                                // ),
                                Flexible(
                                  child: (meetingData.registrationLink!= null &&  meetingData.registrationLink!= '' ) ? ReadMoreText(
                                    ...
                                    text: "No Link Available",    //backend se hi space aara h isme...this should not be happening.
                                    fontWeight: FontWeight.w500,
                                    fontSize: 13,
                                    textColor: ThemeConstants.whitecolor,
                                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //Upload file widget commented as it is already in the add note section
                        // IgnorePointer(
                        //     ignoring: !controller.meetingStartedValue,
                        //     child: Opacity(
                        //       opacity: controller.meetingStartedValue
                      ...
                      children: [
                        controller.showTheStartEndOptions
                            ...
                            : InkWell(
                                onTap: () async {
                                  getToast(
                                      'Only coordinator and creator can start the meeting');
                                  // if (controller.meetingStartedValue ==
                                  //         false &&
                                  //     controller.meetingEndedValue ==
                                  //         false) {
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text("${widget.title}", style: GoogleFonts.aBeeZee(
                textStyle: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.w500,
                  color: ThemeConstants.paleYellow,
              ...
              if (widget.nameList.length > 1) ...[
                ...
                InkWell(
                  ...
                  child: Text(
                    'View all     ',
                    style: TextStyle(
                        fontSize: ThemeConstants.fontSizeMedium.toDouble(),
                        color: ThemeConstants.paleYellow,
