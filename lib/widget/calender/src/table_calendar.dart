...
class TableCalendar<T> extends StatefulWidget {
  ...
  final void Function()? onTapHeaderCustomButton;

  /// Creates a `TableCalendar` widget.
  TableCalendar({
    Key? key,
    this.onTapHeaderCustomButton,
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  // _onTapHeaderCustomButton() {
  //   if (widget.onTapHeaderCustomButton != null) {
  //     return widget.onTapHeaderCustomButton;
  //   }
  // }
          ...
          ValueListenableBuilder<DateTime>(
            ...
            builder: (context, value, _) {
              return CalendarHeader(
                onTapCustomButtonInHeader: () {
                  widget.onTapHeaderCustomButton?.call();
                },
