class SnackBarConstants {
  static String? notestype = "Kindly select notes for";
  static String? noteTextField = "Kindly enter notes";
  static String? toastForUploadFile = "Kindly enter notes";
  ...
  static String? requiredFields = "Please fill required fields";
}
