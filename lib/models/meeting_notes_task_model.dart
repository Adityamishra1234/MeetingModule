class MeetingNotesTaskModel {
  ...
  MeetingNotesTaskModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    meetingName = json['meeting_name'] != null
        ? new MeetingName.fromJson(json['meeting_name'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.meetingName != null) {
      data['meeting_name'] = this.meetingName!.toJson();
    }
    return data;
  }
}
...
class MeetingName {
  ...
  MeetingName({this.nameOfTheMeeting});

  MeetingName.fromJson(Map<String, dynamic> json) {
